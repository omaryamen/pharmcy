...
LOCAL_APPS = [
    ...
    "apps.stock_movement.apps.StockMovementConfig",
    "apps.stock_adjustment.apps.StockAdjustmentConfig",
    "apps.stock_transfer.apps.StockTransferConfig",
    ...
    "apps.accounts_receivable.apps.AccountsReceivableConfig",
